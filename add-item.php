                        ...
                        <div class="my-5">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mt-3">
                                    <input type="text" class="form-control bg-light form" id="priceID" name="price" placeholder=" ">
                                    <label for="priceID" class="fw-bold">Price</label>
                                </div>  
                                <div class="form-floating mt-3">
                                    <input type="text" class="form-control bg-light form" id="stockID" name="stock" placeholder=" ">
                                ...
                                <div class="form-floating mb-5 mt-3">
                                    <textarea class="form-control bg-light form" id="txt" placeholder=" " style="height: 300px;" name="desc"></textarea>
                                ...
                                <button class="btn btn-success btn-green btn-small px-5" type="submit" name="btn-upload">Upload</button>
