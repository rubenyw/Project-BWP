...
CREATE TABLE `htrans_beli` (
  ...
  `hb_status` bit(1) NOT NULL DEFAULT b'0' COMMENT '0:pending\r\n1:accepted',
  PRIMARY KEY (`hb_id`),
...
('US001','rubenyw','rubenyasonwinarta@gmail.com',1,'960cb8f99c665d781c60cc6be4a99ee1',1),
('US002','yurtan','pidiyartoyurtan@gmail.com',1,'7042ad62b32d862449d3dc43c4f09375',1),
